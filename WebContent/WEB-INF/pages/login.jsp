          ...
          <form accept-charset="utf-8" action="#" class="simform">
           <div class="sminputs">
              <div class="input full">
                ...
                <input class="string optional" maxlength="255" id="user-email" placeholder="Name" type="email" size="50" />
              </div>
            </div>
            ...
            <div class="sminputs">
             ...
             <div class="sminputs">
              <div class="input full">
                <label class="string optional" for="user-name">Address*</label>
                <input class="string optional" maxlength="255" id="user-email" placeholder="address"  size="50" />
              </div>
            </div>
